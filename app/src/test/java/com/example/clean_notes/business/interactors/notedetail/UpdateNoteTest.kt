package com.example.clean_notes.business.interactors.notedetail
...
import com.example.clean_notes.business.data.network.FORCE_UPDATE_NOTE_EXCEPTION
...
import com.example.clean_notes.business.interactors.notedetail.UpdateNote.Companion.UPDATE_NOTE_FAILED
import com.example.clean_notes.business.interactors.notedetail.UpdateNote.Companion.UPDATE_NOTE_SUCCESS
import com.example.clean_notes.di.DependencyContainer
import com.example.clean_notes.framework.presentation.notedetail.state.NoteDetailStateEvent.*
import com.example.clean_notes.framework.presentation.notedetail.state.NoteDetailViewState
