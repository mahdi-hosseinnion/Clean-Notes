package com.example.clean_notes.framework.datasource.cache.abstraction

import com.example.clean_notes.business.domain.model.Note
import com.example.clean_notes.framework.datasource.database.NOTE_PAGINATION_PAGE_SIZE
